...
public class Strawberry extends Fruit {
    ...
    int y;
    public String Name;
    public Strawberry() {setName();}

    @Override
    public void setName() { this.Name="StrawBerry"; }
    ...
    public ImageIcon getBufferedImage() {
        if (sliced==true) return new ImageIcon("slicedstrawberry.png");
        else return new ImageIcon("strawberry.png");
    }
